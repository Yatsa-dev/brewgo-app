// Тимчасові дані для демонстрації компонентів. У наступному завданні
// цей файл замінить запит до API, тому структура полів уже наближена
// до того, що повертатиме сервер.
